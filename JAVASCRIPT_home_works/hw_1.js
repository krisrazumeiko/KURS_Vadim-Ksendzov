...
console.log('item_6 ==', item_6, typeof(item_6))                //21. Вывести в консоль тип данных item_6 в виде ——  “item_6 == ”  item_6,  
console.log('item_6_type ==', item_6_type, typeof(item_6_type)) //“item_6_type == ”  item_6_type ——
...
console.log('item_7 ==', item_7, typeof(item_7)) //25. Вывести в консоль тип данных item_7 в виде ——  “item_7 == ”  item_7,  
                                                //“item_7_type == ”  item_7_type ——

let age_1 = 17                      //26. Создать переменную “age_1” и присвоить ей значение 10
let age_2 = 18                      //27. Создать переменную “age_2” и присвоить ей значение 18
let age_3 = 61                      //28. Создать переменную “age_3” и присвоить ей значение 60

if (age_1){                         //29. Создать if в котором будите проверять значение переменной age_1
    console.log("age_1 =", age_1)
} 

if (age_1 < age_2){     //30. Если age_1 < age_2, вывести в консоль “You don’t have access cause your age is ” + age_1 + “ It’s less then ”
